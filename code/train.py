...
def main(_):
    ...
    dataset = mask_dataset(FLAGS.data_dir, set_names=set_names, suffixes=suffixes)
    answers = read_answers(FLAGS.data_dir)
    raw_answers = read_raw_answers(FLAGS.data_dir)
